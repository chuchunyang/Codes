...
Location::Location(const Location &oldLocation)
{
    for(int i = 0; i < oldLocation.things.size(); i++)
    {
        //std::cout << "How many things? " << oldLocation.count << std::endl;
        //Thing *temp = oldLocation.things[i];
        things.push_back(oldLocation.things[i]);
    }
